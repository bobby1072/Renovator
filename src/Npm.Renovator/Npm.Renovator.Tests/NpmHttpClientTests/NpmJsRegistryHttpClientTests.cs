    ...
    public class NpmJsRegistryHttpClientTests : IDisposable
    {
        ...
        public NpmJsRegistryHttpClientTests()
        {
            _httpClient = new NpmJsRegistryHttpClient(
                new TestOptionsSnapshot<NpmJsRegistryHttpClientSettingsConfiguration>(
                    _settings
                ).Object,
                _serialiser,
                _mockLogger.Object
        ...
        public async Task Client_Builds_Request_Correctly()
        {
            ...
            _httpTest
                .ForCallsTo(
                    $"{_baseURl}/-/v1/search?text={mockedNpmJsRegistryBody.Text}&size={mockedNpmJsRegistryBody.Size}"
                )
                .WithVerb(HttpMethod.Get)
                .RespondWith(
                    JsonSerializer.Serialize(
                        mockedNpmJsRegistryResponse,
